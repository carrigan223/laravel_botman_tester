! function(t) {
    ...
    function f(t) { return "[object File]" === O.call(t) }

    function h(t) { return "[object Blob]" === O.call(t) }
    ...
    function b(t) { return t.replace(/^\s*/, "").replace(/\s*$/, "") }
    ...
    function k(t, e, n) { return g(e, function(e, r) { t[r] = n && "function" == typeof e ? x(e, n) : e }), t }
    var x = n(3),
        _ = n(12),
        O = Object.prototype.toString;
    t.exports = { isArray: r, isArrayBuffer: o, isBuffer: _, isFormData: i, isArrayBufferView: s, isString: a, isNumber: c, isObject: p, isUndefined: u, isDate: l, isFile: f, isBlob: h, isFunction: d, isStream: v, isURLSearchParams: y, isStandardBrowserEnv: m, forEach: g, merge: w, extend: k, trim: b }
}, function(t, e, n) {
    "use strict";

    function r(t, e) {
        var n, r, o, i, s = P;
        for (i = arguments.length; i-- > 2;) B.push(arguments[i]);
        for (e && null != e.children && (B.length || B.push(e.children), delete e.children); B.length;)
            if ((r = B.pop()) && void 0 !== r.pop)
                for (i = r.length; i--;) B.push(r[i]);
            else "boolean" == typeof r && (r = null), (o = "function" != typeof t) && (null == r ? r = "" : "number" == typeof r ? r += "" : "string" != typeof r && (o = !1)), o && n ? s[s.length - 1] += r : s === P ? s = [r] : s.push(r), n = o;
        var a = new N;
        return a.nodeName = t, a.children = s, a.attributes = null == e ? void 0 : e, a.key = null == e ? void 0 : e.key, void 0 !== A.vnode && A.vnode(a), a
    }
    ...
    function s(t) {!t._dirty && (t._dirty = !0) && 1 == I.push(t) && (A.debounceRendering || R)(a) }
    ...
    function d(t) { return this._listeners[t.type](A.event && A.event(t) || t) }

    function v() { for (var t; t = U.shift();) A.afterMount && A.afterMount(t), t.componentDidMount && t.componentDidMount() }

    function y(t, e, n, r, o, i) { L++ || (M = null != o && void 0 !== o.ownerSVGElement, q = null != t && !("__preactattr_" in t)); var s = b(t, e, n, r, i); return o && s.parentNode !== o && o.appendChild(s), --L || (q = !1, i || v()), s }
    ...
    function b(t, e, n, r, o) {
        ...
        var c = i.firstChild,
            p = i.__preactattr_,
            f = e.children;
        if (null == p) { p = i.__preactattr_ = {}; for (var h = i.attributes, d = h.length; d--;) p[h[d].name] = h[d].value }
        return !q && f && 1 === f.length && "string" == typeof f[0] && null != c && void 0 !== c.splitText && null == c.nextSibling ? c.nodeValue != f[0] && (c.nodeValue = f[0]) : (f && f.length || null != c) && m(i, f, n, r, q || null != p.dangerouslySetInnerHTML), k(i, e.attributes, p), M = s, i
    }
    ...
    function m(t, e, n, r, o) {
        ...
        if (0 !== m)
            for (var x = 0; m > x; x++) {
                var _ = l[x],
                    O = _.__preactattr_,
                    C = k && O ? _._component ? _._component.__key : O.key : null;
                null != C ? (v++, d[C] = _) : (O || (void 0 !== _.splitText ? !o || _.nodeValue.trim() : o)) && (h[w++] = _)
            }
        if (0 !== k)
            for (var x = 0; k > x; x++) {
                u = e[x], p = null;
                ...
                if (null != C) v && void 0 !== d[C] && (p = d[C], d[C] = void 0, v--);
                    ...
                    for (i = y; w > i; i++)
                        if (void 0 !== h[i] && c(s = h[i], u, o)) { p = s, h[i] = void 0, i === w - 1 && w--, i === y && y++; break }
                p = b(p, u, n, r), a = l[x], p && p !== t && p !== a && (null == a ? t.appendChild(p) : p === a.nextSibling ? f(a) : t.insertBefore(p, a))
            }
        if (v)
            for (var x in d) void 0 !== d[x] && g(d[x], !1);
        for (; w >= y;) void 0 !== (p = h[w--]) && g(p, !1)
    }

    function g(t, e) {
        var n = t._component;
        n ? S(n) : (null != t.__preactattr_ && i(t.__preactattr_.ref, null), !1 !== e && null != t.__preactattr_ || f(t), w(t))
    }
    ...
    function k(t, e, n) { var r; for (r in n) e && null != e[r] || null == n[r] || h(t, r, n[r], n[r] = void 0, M); for (r in e) "children" === r || "innerHTML" === r || r in n && e[r] === ("value" === r || "checked" === r ? t[r] : n[r]) || h(t, r, n[r], n[r] = e[r], M) }
    ...
    function O(t, e, n, r, o) { t._disable || (t._disable = !0, t.__ref = e.ref, t.__key = e.key, delete e.ref, delete e.key, void 0 === t.constructor.getDerivedStateFromProps && (!t.base || o ? t.componentWillMount && t.componentWillMount() : t.componentWillReceiveProps && t.componentWillReceiveProps(e, r)), r && r !== t.context && (t.prevContext || (t.prevContext = t.context), t.context = r), t.prevProps || (t.prevProps = t.props), t.props = e, t._disable = !1, 0 !== n && (1 !== n && !1 === A.syncComponentUpdates && t.base ? s(t) : C(t, 1, o)), i(t.__ref, t)) }
    ...
    function C(t, e, n, r) {
        if (!t._disable) {
            ...
            if (t.constructor.getDerivedStateFromProps && (u = o(o({}, u), t.constructor.getDerivedStateFromProps(c, u)), t.state = u), b && (t.props = f, t.state = h, t.context = d, 2 !== e && t.shouldComponentUpdate && !1 === t.shouldComponentUpdate(c, u, l) ? _ = !0 : t.componentWillUpdate && t.componentWillUpdate(c, u, l), t.props = c, t.state = u, t.context = l), t.prevProps = t.prevState = t.prevContext = t.nextBase = null, t._dirty = !1, !_) {
                i = t.render(c, u, l), t.getChildContext && (l = o(o({}, l), t.getChildContext())), b && t.getSnapshotBeforeUpdate && (j = t.getSnapshotBeforeUpdate(f, h));
                var E, T, N = i && i.nodeName;
                if ("function" == typeof N) {
                    var B = p(i);
                    s = k, s && s.constructor === N && B.key == s.__key ? O(s, B, 1, l, !1) : (E = s, t._component = s = x(N, B, l), s.nextBase = s.nextBase || m, s._parentComponent = t, O(s, B, 0, l, !1), C(s, 1, n, !0)), T = s.base
                } else a = w, E = k, E && (a = t._component = null), (w || 1 === e) && (a && (a._component = null), T = y(a, i, l, n || !b, w && w.parentNode, !0));
                if (w && T !== w && s !== k) {
                    var P = w.parentNode;
                    P && T !== P && (P.replaceChild(T, w), E || (w._component = null, g(w, !1)))
                }
                if (E && S(E), t.base = T, T && !r) {
                    for (var R = t, F = t; F = F._parentComponent;)(R = F).base = T;
                    T._component = R, T._componentConstructor = R.constructor
                }
            }
            for (!b || n ? U.push(t) : _ || (t.componentDidUpdate && t.componentDidUpdate(f, h, j), A.afterUpdate && A.afterUpdate(t)); t._renderCallbacks.length;) t._renderCallbacks.pop().call(t);
            L || r || v()
        }
    }

    function j(t, e, n, r) { for (var o = t && t._component, i = o, s = t, a = o && t._componentConstructor === e.nodeName, c = a, u = p(e); o && !c && (o = o._parentComponent);) c = o.constructor === e.nodeName; return o && c && (!r || o._component) ? (O(o, u, 3, n, r), t = o.base) : (i && !a && (S(i), t = s = null), o = x(e.nodeName, u, n), t && !o.nextBase && (o.nextBase = t, s = null), O(o, u, 1, n, r), t = o.base, s && t !== s && (s._component = null, g(s, !1))), t }
    ...
    function S(t) {
        ...
        var n = t._component;
        n ? S(n) : e && (null != e.__preactattr_ && i(e.__preactattr_.ref, null), t.nextBase = e, f(e), W.push(t), w(e)), i(t.__ref, null)
    }

    function E(t, e) { this._dirty = !0, this.context = e, this.props = t, this.state = this.state || {}, this._renderCallbacks = [] }

    function T(t, e, n) { return y(n, t, {}, !1, e, !1) }
    ...
    var r = { position: "fixed", bottom: "60px", right: "30px", zIndex: 2147483647, borderRadius: "5px", boxSizing: "content-box", boxShadow: "0px 0px 20px rgba(0, 0, 0, 0.2)", overflow: "hidden" },
        ...
        u = { display: "flex", position: "absolute", justifyContent: "center", alignItems: "center", top: "26px", right: "20px", height: "70px", width: "70px", border: 0, borderRadius: "50%", boxShadow: "0px 0px 20px rgba(0, 0, 0, 0.2)" },
    ...
    e.a = function(t) {
        ...
        return h(e, t), e.prototype.componentDidMount = function() { window.botmanChatWidget = new p.a(this), this.setupEcho(), "function" == typeof this.props.conf.init && this.props.conf.init(window.botmanChatWidget) }, e.prototype.setupEcho = function() {
            if (!0 === this.props.conf.useEcho) {
                this.Echo = new f.a(this.props.conf.echoConfiguration);
                var t = void 0;
